        ...
        <div className='row'>
          <div className='col d-flex justify-content-center'>
            <p className='white'>
              ...
              background to find creative solutions to modern day problems. I
              earned a certificate in Full Stack Web Development from the
              University of Minnesota, and possess newly developed skills in
              HTML, CSS, JavaScript, React.js and responsive website design. I
              am known as a team player passionate about developing
              applications, with a focus on mobile-first design and development.
              With each project, my aim is to best engage my audience for an
              impactful user experience. I’m excited to leverage my skills as
